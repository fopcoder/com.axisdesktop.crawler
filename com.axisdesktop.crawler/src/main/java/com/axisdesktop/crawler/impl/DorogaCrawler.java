...
public class DorogaCrawler extends Crawler {
	private Queue queue;
	// private AxisProducer prod;
	// private Session session;

	private final String propertiesFileName = "crawler2.properties";

	public DorogaCrawler() throws IOException {
		...
		Provider prov = provService.createIfNotExists( "doroga.ua", ProviderStatus.ACTIVE );

		for( String u : importFeedUrls( "feed2.urls" ) ) {
	...
	protected Worker createWorker( URI uri ) {
		return new DorogaWorker( this, uri );
	}
